...
export class OrderItemDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('kstoreApp.kproductOrderItem.delete.question'));
...
export default class OrderItemComponentsPage {
  ...
  async deleteOrderItem() {
    ...
    expect(await orderItemDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/kstoreApp.kproductOrderItem.delete.question/);
