...
export class ProductDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('kstoreApp.kproductProduct.delete.question'));
...
export default class ProductComponentsPage {
  ...
  async deleteProduct() {
    ...
    expect(await productDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/kstoreApp.kproductProduct.delete.question/);
