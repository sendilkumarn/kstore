...
export class ProductOrderDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('kstoreApp.kproductProductOrder.delete.question'));
...
export default class ProductOrderComponentsPage {
  ...
  async deleteProductOrder() {
    ...
    expect(await productOrderDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/kstoreApp.kproductProductOrder.delete.question/);
