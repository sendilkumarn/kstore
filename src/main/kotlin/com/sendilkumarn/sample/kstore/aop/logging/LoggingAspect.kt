package com.sendilkumarn.sample.kstore.aop.logging
...
open class LoggingAspect(private val env: Environment) {
     ...
     */
    @Pointcut(
        "within(com.sendilkumarn.sample.kstore.repository..*)" +
            " || within(com.sendilkumarn.sample.kstore.service..*)" +
            " || within(com.sendilkumarn.sample.kstore.web.rest..*)"
    )
