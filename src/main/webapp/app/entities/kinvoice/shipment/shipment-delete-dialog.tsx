...
export const ShipmentDeleteDialog = (props: IShipmentDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="kstoreApp.kinvoiceShipment.delete.question">
        <Translate contentKey="kstoreApp.kinvoiceShipment.delete.question" interpolate={{ id: shipmentEntity.id }}>
