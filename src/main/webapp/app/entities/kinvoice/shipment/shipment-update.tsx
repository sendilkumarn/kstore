...
import { getEntities as getInvoices } from 'app/entities/kinvoice/invoice/invoice.reducer';
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="kstoreApp.kinvoiceShipment.home.createOrEditLabel">
            <Translate contentKey="kstoreApp.kinvoiceShipment.home.createOrEditLabel">Create or edit a Shipment</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : shipmentEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="trackingCodeLabel" for="shipment-trackingCode">
                  <Translate contentKey="kstoreApp.kinvoiceShipment.trackingCode">Tracking Code</Translate>
                </Label>
                <AvField id="shipment-trackingCode" type="text" name="trackingCode" />
              </AvGroup>
              <AvGroup>
                <Label id="dateLabel" for="shipment-date">
                  <Translate contentKey="kstoreApp.kinvoiceShipment.date">Date</Translate>
                </Label>
                <AvInput
                  id="shipment-date"
                  type="datetime-local"
              ...
              <AvGroup>
                <Label id="detailsLabel" for="shipment-details">
                  <Translate contentKey="kstoreApp.kinvoiceShipment.details">Details</Translate>
                </Label>
                <AvField id="shipment-details" type="text" name="details" />
              </AvGroup>
              <AvGroup>
                <Label for="shipment-invoice">
                  <Translate contentKey="kstoreApp.kinvoiceShipment.invoice">Invoice</Translate>
                </Label>
                <AvInput
                  id="shipment-invoice"
                  type="select"
