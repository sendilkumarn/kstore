...
export const Shipment = (props: IShipmentProps) => {
  ...
  const { shipmentList, match, loading, totalItems } = props;
  return (
    <div>
      <h2 id="shipment-heading">
        <Translate contentKey="kstoreApp.kinvoiceShipment.home.title">Shipments</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="kstoreApp.kinvoiceShipment.home.createLabel">Create new Shipment</Translate>
        </Link>
      </h2>
        ...
        {shipmentList && shipmentList.length > 0 ? (
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('trackingCode')}>
                  <Translate contentKey="kstoreApp.kinvoiceShipment.trackingCode">Tracking Code</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('date')}>
                  <Translate contentKey="kstoreApp.kinvoiceShipment.date">Date</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('details')}>
                  <Translate contentKey="kstoreApp.kinvoiceShipment.details">Details</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="kstoreApp.kinvoiceShipment.invoice">Invoice</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="kstoreApp.kinvoiceShipment.home.notFound">No Shipments found</Translate>
            </div>
          )
        )}
      </div>
