...
import { getEntities as getProducts } from 'app/entities/kproduct/product/product.reducer';
import { IProductOrder } from 'app/shared/model/kproduct/product-order.model';
import { getEntities as getProductOrders } from 'app/entities/kproduct/product-order/product-order.reducer';
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="kstoreApp.kproductOrderItem.home.createOrEditLabel">
            <Translate contentKey="kstoreApp.kproductOrderItem.home.createOrEditLabel">Create or edit a OrderItem</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : orderItemEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="quantityLabel" for="order-item-quantity">
                  <Translate contentKey="kstoreApp.kproductOrderItem.quantity">Quantity</Translate>
                </Label>
                <AvField
              ...
              <AvGroup>
                <Label id="totalPriceLabel" for="order-item-totalPrice">
                  <Translate contentKey="kstoreApp.kproductOrderItem.totalPrice">Total Price</Translate>
                </Label>
                <AvField
              ...
              <AvGroup>
                <Label id="statusLabel" for="order-item-status">
                  <Translate contentKey="kstoreApp.kproductOrderItem.status">Status</Translate>
                </Label>
                <AvInput
                ...
                >
                  <option value="AVAILABLE">{translate('kstoreApp.OrderItemStatus.AVAILABLE')}</option>
                  <option value="OUT_OF_STOCK">{translate('kstoreApp.OrderItemStatus.OUT_OF_STOCK')}</option>
                  <option value="BACK_ORDER">{translate('kstoreApp.OrderItemStatus.BACK_ORDER')}</option>
                </AvInput>
              </AvGroup>
              <AvGroup>
                <Label for="order-item-product">
                  <Translate contentKey="kstoreApp.kproductOrderItem.product">Product</Translate>
                </Label>
                <AvInput
              ...
              <AvGroup>
                <Label for="order-item-order">
                  <Translate contentKey="kstoreApp.kproductOrderItem.order">Order</Translate>
                </Label>
                <AvInput
                  id="order-item-order"
                  type="select"
