  ...
  return (
    <div>
      <h2 id="order-item-heading">
        <Translate contentKey="kstoreApp.kproductOrderItem.home.title">Order Items</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="kstoreApp.kproductOrderItem.home.createLabel">Create new Order Item</Translate>
        </Link>
      </h2>
        ...
        {orderItemList && orderItemList.length > 0 ? (
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('quantity')}>
                  <Translate contentKey="kstoreApp.kproductOrderItem.quantity">Quantity</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('totalPrice')}>
                  <Translate contentKey="kstoreApp.kproductOrderItem.totalPrice">Total Price</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('status')}>
                  <Translate contentKey="kstoreApp.kproductOrderItem.status">Status</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="kstoreApp.kproductOrderItem.product">Product</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="kstoreApp.kproductOrderItem.order">Order</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {orderItemList.map((orderItem, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>
                    <Translate contentKey={`kstoreApp.OrderItemStatus.${orderItem.status}`} />
                  </td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="kstoreApp.kproductOrderItem.home.notFound">No Order Items found</Translate>
            </div>
          )
        )}
      </div>
