...
export const OrderItemDeleteDialog = (props: IOrderItemDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="kstoreApp.kproductOrderItem.delete.question">
        <Translate contentKey="kstoreApp.kproductOrderItem.delete.question" interpolate={{ id: orderItemEntity.id }}>
