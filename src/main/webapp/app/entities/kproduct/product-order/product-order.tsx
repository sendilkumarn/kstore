  ...
  return (
    <div>
      <h2 id="product-order-heading">
        <Translate contentKey="kstoreApp.kproductProductOrder.home.title">Product Orders</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="kstoreApp.kproductProductOrder.home.createLabel">Create new Product Order</Translate>
        </Link>
      </h2>
        ...
        {productOrderList && productOrderList.length > 0 ? (
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('placedDate')}>
                  <Translate contentKey="kstoreApp.kproductProductOrder.placedDate">Placed Date</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('status')}>
                  <Translate contentKey="kstoreApp.kproductProductOrder.status">Status</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('code')}>
                  <Translate contentKey="kstoreApp.kproductProductOrder.code">Code</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('invoiceId')}>
                  <Translate contentKey="kstoreApp.kproductProductOrder.invoiceId">Invoice Id</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('customer')}>
                  <Translate contentKey="kstoreApp.kproductProductOrder.customer">Customer</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {productOrderList.map((productOrder, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>
                    <Translate contentKey={`kstoreApp.OrderStatus.${productOrder.status}`} />
                  </td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="kstoreApp.kproductProductOrder.home.notFound">No Product Orders found</Translate>
            </div>
          )
        )}
      </div>
