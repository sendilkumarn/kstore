...
export const ProductOrderDeleteDialog = (props: IProductOrderDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="kstoreApp.kproductProductOrder.delete.question">
        <Translate contentKey="kstoreApp.kproductProductOrder.delete.question" interpolate={{ id: productOrderEntity.id }}>
