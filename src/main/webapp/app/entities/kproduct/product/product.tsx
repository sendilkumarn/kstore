  ...
  return (
    <div>
      <h2 id="product-heading">
        <Translate contentKey="kstoreApp.kproductProduct.home.title">Products</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="kstoreApp.kproductProduct.home.createLabel">Create new Product</Translate>
        </Link>
      </h2>
        ...
        {productList && productList.length > 0 ? (
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('name')}>
                  <Translate contentKey="kstoreApp.kproductProduct.name">Name</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('description')}>
                  <Translate contentKey="kstoreApp.kproductProduct.description">Description</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('price')}>
                  <Translate contentKey="kstoreApp.kproductProduct.price">Price</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('size')}>
                  <Translate contentKey="kstoreApp.kproductProduct.size">Size</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('image')}>
                  <Translate contentKey="kstoreApp.kproductProduct.image">Image</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
            ...
            <tbody>
              {productList.map((product, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{product.price}</td>
                  <td>
                    <Translate contentKey={`kstoreApp.Size.${product.size}`} />
                  </td>
                  <td>
                    {product.image ? (
                      <div>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="kstoreApp.kproductProduct.home.notFound">No Products found</Translate>
            </div>
          )
        )}
      </div>
