...
import { IProductCategory } from 'app/shared/model/kproduct/product-category.model';
import { getEntities as getProductCategories } from 'app/entities/kproduct/product-category/product-category.reducer';
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="kstoreApp.kproductProduct.home.createOrEditLabel">
            <Translate contentKey="kstoreApp.kproductProduct.home.createOrEditLabel">Create or edit a Product</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : productEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="nameLabel" for="product-name">
                  <Translate contentKey="kstoreApp.kproductProduct.name">Name</Translate>
                </Label>
                <AvField
                  id="product-name"
                  type="text"
              ...
              <AvGroup>
                <Label id="descriptionLabel" for="product-description">
                  <Translate contentKey="kstoreApp.kproductProduct.description">Description</Translate>
                </Label>
                <AvField id="product-description" type="text" name="description" />
              </AvGroup>
              <AvGroup>
                <Label id="priceLabel" for="product-price">
                  <Translate contentKey="kstoreApp.kproductProduct.price">Price</Translate>
                </Label>
                <AvField
                  id="product-price"
                  type="text"
              ...
              <AvGroup>
                <Label id="sizeLabel" for="product-size">
                  <Translate contentKey="kstoreApp.kproductProduct.size">Size</Translate>
                </Label>
                <AvInput id="product-size" type="select" className="form-control" name="size" value={(!isNew && productEntity.size) || 'S'}>
                  <option value="S">{translate('kstoreApp.Size.S')}</option>
                  <option value="M">{translate('kstoreApp.Size.M')}</option>
                  <option value="L">{translate('kstoreApp.Size.L')}</option>
                  <option value="XL">{translate('kstoreApp.Size.XL')}</option>
                  <option value="XXL">{translate('kstoreApp.Size.XXL')}</option>
                </AvInput>
              </AvGroup>
              <AvGroup>
                <AvGroup>
                  <Label id="imageLabel" for="image">
                    <Translate contentKey="kstoreApp.kproductProduct.image">Image</Translate>
                  </Label>
                  <br />
                  {image ? (
                    <div>
              ...
              <AvGroup>
                <Label for="product-productCategory">
                  <Translate contentKey="kstoreApp.kproductProduct.productCategory">Product Category</Translate>
                </Label>
